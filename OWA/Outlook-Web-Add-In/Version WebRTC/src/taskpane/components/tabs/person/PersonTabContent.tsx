...
useEffect(() => {
 //const socket = new JsSIP.WebSocketInterface('ws://192.168.0.110:8081');
  const socket = new JsSIP.WebSocketInterface('wss://127.0.0.1:443');

 
  const configuration = {
    sockets: [socket],
    uri: 'sip:1001@127.0.0.1:443',
  //  password: 'tajneHaslo'
  };
  ...
  ua.on('registered', () => console.log('Zarejestrowano w JsSIP'));
  ua.on('newRTCSession', (e) => {
    ...
    if (e.originator === 'remote') {
      ...
      debugger;
      console.log('Przychodzące połączenie SIP w JsSIP');
      session.answer({
...
// useEffect(() => {
//   const socket = new JsSIP.WebSocketInterface('wss://twoj-sip-server:7443');
//   const configuration = {
//     sockets: [socket],
//     uri: 'sip:1001@twoj-sip-server',
//     password: 'tajneHaslo'
//   };
