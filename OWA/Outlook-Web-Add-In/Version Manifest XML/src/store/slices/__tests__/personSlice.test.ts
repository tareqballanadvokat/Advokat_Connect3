  ...
  describe("WebRTC Service Error Handling", () => {
    ...
    describe("getFavoritePersonsAsync", () => {
      it("should handle network timeouts", async () => {
        ...
        const result = await getFavoritePersonsAsync({ NurFavoriten: true, Count: 10 })(
          dispatch,
          getState,
          undefined
        );
      ...
      it("should handle connection refused errors", async () => {
        ...
        const result = await getFavoritePersonsAsync({ NurFavoriten: true })(
          dispatch,
          getState,
          undefined
        );
    ...
    describe("removePersonFromFavoritesAsync", () => {
      ...
      it("should handle connection refused errors", async () => {
        mockWebRTCService.removePersonFromFavorites.mockRejectedValue(
