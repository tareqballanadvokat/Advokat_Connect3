...
| Guide | Scope | Status |
|---|---|---|
| [TESTING_GUIDE_SLICES.md](./TESTING_GUIDE_SLICES.md) | Unit tests — Redux slices | ✅ 632 tests passing |
| [TESTING_GUIDE_SERVICES.md](./TESTING_GUIDE_SERVICES.md) | Unit tests — Services | ❌ Not started |
| [TESTING_GUIDE_SIP.md](./TESTING_GUIDE_SIP.md) | Unit tests — SIP infrastructure | ❌ Not started |
| [TESTING_GUIDE_COMPONENTS.md](./TESTING_GUIDE_COMPONENTS.md) | Component tests (React Testing Library) | ❌ Not started |
| [TESTING_GUIDE_INTEGRATION.md](./TESTING_GUIDE_INTEGRATION.md) | Integration tests | ❌ Not started |
| [TESTING_GUIDE_E2E.md](./TESTING_GUIDE_E2E.md) | End-to-end tests (Playwright) | ❌ Not started |
...
→ **[Full guide: TESTING_GUIDE_SLICES.md](./TESTING_GUIDE_SLICES.md)**
...
→ **[Full guide: TESTING_GUIDE_SERVICES.md](./TESTING_GUIDE_SERVICES.md)**
...
→ **[Full guide: TESTING_GUIDE_SIP.md](./TESTING_GUIDE_SIP.md)**
...
→ **[Full guide: TESTING_GUIDE_COMPONENTS.md](./TESTING_GUIDE_COMPONENTS.md)**
...
→ **[Full guide: TESTING_GUIDE_INTEGRATION.md](./TESTING_GUIDE_INTEGRATION.md)**
...
→ **[Full guide: TESTING_GUIDE_E2E.md](./TESTING_GUIDE_E2E.md)**
...
|---|---|---|---|
| 1 | `pairingSlice` unit test | [Slices](./TESTING_GUIDE_SLICES.md) | Small |
| 2 | `OfficeAuthService` unit test | [Services](./TESTING_GUIDE_SERVICES.md) | Small |
| 3 | `TokenService` unit test | [Services](./TESTING_GUIDE_SERVICES.md) | Small–Medium |
| 4 | `MessageFactory` + `Helper` + `TimeoutManager` | [SIP](./TESTING_GUIDE_SIP.md) | Small |
| 5 | `renderWithProviders` helper + `App.tsx` component test | [Components](./TESTING_GUIDE_COMPONENTS.md) | Medium |
| 6 | Remaining component tests (tabs) | [Components](./TESTING_GUIDE_COMPONENTS.md) | Medium per tab |
| 7 | `IdleActivityMonitor` unit test | [Services](./TESTING_GUIDE_SERVICES.md) | Medium |
| 8 | `WebRTCDataChannelService` unit test | [Services](./TESTING_GUIDE_SERVICES.md) | Medium |
| 9 | `Registration` + `EstablishingConnection` unit tests | [SIP](./TESTING_GUIDE_SIP.md) | Medium |
| 10 | `WebRTCConnectionManager` unit test | [Services](./TESTING_GUIDE_SERVICES.md) | High |
| 11 | Integration tests (token, pairing, idle) | [Integration](./TESTING_GUIDE_INTEGRATION.md) | Medium |
| 12 | E2E tests | [E2E](./TESTING_GUIDE_E2E.md) | High |
