...
namespace WebRTCClient
{
    ...
    public class WebRTCPeer : IWebRTCPeer
    {
        ...
        public WebRTCConfig Config { get; set; }
        ...
        public async Task Connect()
        {
            ...
            this.sipClient.Config = this.Config;
        ...
        private async Task WaitForDirectConnection(SIPClient sender)
        {
            await WaitForAsync(
                ...
                timeOut: this.Config.P2PConnectionTimeout, // TODO: find suitable timout for p2p connection
