...
//-----------------------------------------------------------------------------
//https://github.com/sipsorcery-org/sipsorcery/blob/master/examples/WebRTCExamples/WebRTCGetStartedDataChannel/Program.cs
using System;
...
namespace demo
{
    class Program
    {
        ...
        private async static Task<RTCPeerConnection> CreatePeerConnection()
        {
            ...
            var dc = await pc.createDataChannel("dc1", null);
