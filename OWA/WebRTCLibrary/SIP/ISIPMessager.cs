...
namespace WebRTCLibrary.SIP
{
    public interface ISIPMessager
    {
        ...
        public Task<SocketError> SendRequest(SIPMethodsEnum method, string? message, int cSeq);
        public Task<SocketError> SendResponse(SIPResponseStatusCodesEnum statusCode, string? message, int cSeq);
    }
}
