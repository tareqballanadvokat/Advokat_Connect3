...
//            publishRequest.Header.From = new SIPFromHeader("client", new SIPURI("client", serverIp, null), null);
//            publishRequest.Header.To = new SIPToHeader("server", new SIPURI("server", serverIp, null), "TAG");
